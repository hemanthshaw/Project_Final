...
import com.rationwala.store.classes.BillingClass
...
class BillingActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var db = FirebaseDatabase.getInstance("https://rationwala-d207b-default-rtdb.firebaseio.com/").getReference("gateway")
                ...
                object : ValueEventListener
                {
                    ...
                    override fun onDataChange(p0: DataSnapshot) {
                        ...
                        if(x.equals("1"))
                        {
                            ...
                            Toast.makeText(this@BillingActivity,"Due to some security reasons we are not accepting any kind of upi payments.",Toast.LENGTH_LONG).show()
                        }
                    }
                ...
                object : ValueEventListener
                {
                    ...
                    override fun onDataChange(p0: DataSnapshot) {
                        ...
                        if(x.equals("1"))
                        {
                            ...
                            Toast.makeText(this@BillingActivity,"Due to some security reasons we are not accepting any kind of online payments",Toast.LENGTH_LONG).show()
                        }
                    }
                            ...
                            alert.setMessage("Do you want confirm order?")
                                ...
                                .setPositiveButton("yes",
                                    DialogInterface.OnClickListener(){ dialogInterface: DialogInterface, i: Int ->
                                        ...
                                        val pd = SimpleArcDialog(this@BillingActivity)
                                        var ar = ArcConfiguration(this@BillingActivity)
                                        ar.colors = colors
    ...
    private fun payUsingUpi() {
        var db = FirebaseDatabase.getInstance("https://rationwala-d207b-default-rtdb.firebaseio.com/").getReference("myinformation").child("upi")
        db.addListenerForSingleValueEvent(
            object : ValueEventListener
            {
                override fun onCancelled(p0: DatabaseError) {
            ...
            object : ValueEventListener {
                ...
                override fun onDataChange(p0: DataSnapshot) {
                    if (p0.exists()) {
                        ...
                        var tb = FirebaseDatabase.getInstance("https://rationwala-d207b-default-rtdb.firebaseio.com/").getReference("orders")
                        val max=999
                        val min=100
                                ...
                                object : ValueEventListener {
                                    ...
                                    override fun onDataChange(p1: DataSnapshot) {
                                        ...
                                        if (lis.size != 0 && it.key.toString().equals(last)) {
                                            ...
                                            var db =FirebaseDatabase.getInstance("https://rationwala-d207b-default-rtdb.firebaseio.com/").getReference("myinformation").child("orderto")
                                            db.addListenerForSingleValueEvent(
                                                object : ValueEventListener {
                                                    override fun onCancelled(p0: DatabaseError) {
                                                    ...
                                                    override fun onDataChange(p0: DataSnapshot) {
                                                        ...
                                                        var b = BillingClass(uid.toString(),d.toString(),intent.getStringExtra("price")!!,intent.getStringExtra("address")!!
                                                            ,intent.getStringExtra("timeslot")!!,s,"pending",intent.getStringExtra("deliverycharges")!!,lis,"0","0","0","0",intent.getStringExtra("couponid")!!)
