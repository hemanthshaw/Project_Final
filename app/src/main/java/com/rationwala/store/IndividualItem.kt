...
class IndividualItem : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var dbase= FirebaseDatabase.getInstance("https://rationwala-d207b-default-rtdb.firebaseio.com/").getReference("categories").child(cat).child("subcategory").child(subcat).child(key)
        dbase.addValueEventListener(
            object : ValueEventListener
            {
                ...
                override fun onDataChange(p0: DataSnapshot) {
                    ...
                    var db1 = FirebaseDatabase.getInstance("https://rationwala-d207b-default-rtdb.firebaseio.com/").getReference("usersinformation").child(FirebaseAuth.getInstance().uid.toString())
                    ...
                    plus.setOnClickListener {
                        /*if(cc.text.toString().toInt()>9)
                        {
                            ...
                            if(c[sp.selectedItemPosition].available.equals("0"))
                        {
                            //Toast.makeText(this@IndividualItem,""+sp.selectedItemPosition,Toast.LENGTH_LONG).show()
                            val builder =
                                AlertDialog.Builder(this@IndividualItem)
