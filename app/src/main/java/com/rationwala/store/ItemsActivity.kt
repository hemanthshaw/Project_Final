...
import com.rationwala.store.adapters.HorizantalAdapter
...
class ItemsActivity : AppCompatActivity(){
    override fun onCreate(savedInstanceState: Bundle?) {
                                            ...
                                            next.setOnClickListener {
                                                startActivity(
                                                    Intent(
                                                        ...
                                                        .putExtra("subcato",intent.getStringExtra("subcato"))
                                                        .putExtra("ac","item").putExtra("activity"
        ...
        /*cart.setOnClickListener {
            startActivity(Intent(this@ItemsActivity,CartActivity::class.java))
        }
